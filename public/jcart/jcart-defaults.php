...
if (!$jcart['text']['subtotal']) $jcart['text']['subtotal']								= '您总共需要支付';
...
if (!$jcart['text']['empty_message']) $jcart['text']['empty_message']					= '您的餐车还没有餐品!';
if (!$jcart['text']['item_added_message']) $jcart['text']['item_added_message']			= '预订成功!';
